					...
					<table style="width: 100%">
						<tr>
							<td style="text-align: left"><strong>What is
								...
								occurs almost exclusively in association with family separation
								or divorce, particularly where legal action is involved. The
								most common cause is one parent wishing to exclude the other
								parent from the life of their child<br>
								<hr style="width: 100%" /> <strong>Mission Statement:</strong><br>
								Provide a simple, centralized location to allow easy access to
								support and educational sites relating to Parental Alienation</td>

							<td
								style="border-left: 1px solid #AAAAAA; width: 200px; vertical-align: top"><center>
									Content Menu<br>Alternate Articles <br>
									<hr style="width: 100%" />
									<span class="auto-style6"><strong><em>
												&lt;coming soon&gt;</em></strong></span>
								</center></td>
						</tr>
					</table>
				</td>
